...
var require_lib2 = __commonJS({
  "node_modules/node-fetch/lib/index.js"(exports2, module2) {
    ...
    function getHeaders(headers) {
      ...
      return keys2.map(kind2 === "key" ? function(k2) {
...
function Z(e2, t2) {
  ...
  e2._readRequests = new S2(), r2.forEach((e3) => {
    e3._errorSteps(t2);
  });
}
function ee(e2) {
...
function ce(e2) {
  e2._queue = new S2(), e2._queueTotalSize = 0;
}
function de(e2) {
...
function he(e2) {
  Re(e2), e2._pendingPullIntos = new S2();
}
function _e(e2, t2) {
  let r2 = false;
...
function Ie(e2, t2) {
  ...
  e2._readIntoRequests = new S2(), r2.forEach((e3) => {
    e3._errorSteps(t2);
  });
}
function De(e2) {
...
function tt(e2) {
  ...
  if (e2._writeRequests.forEach((e3) => {
    e3._reject(t2);
  }), e2._writeRequests = new S2(), void 0 === e2._pendingAbortRequest) return void ot(e2);
...
function kt(e2, t2, r2, o2, n2, a2) {
  ...
  let s2, _2, g2, w2 = false, S3 = false, v2 = "readable", R3 = "writable", T2 = false, q2 = false;
  const C2 = u((e3) => {
    g2 = e3;
  });
  ...
  return u((P2, W3) => {
    ...
    function j2(e3) {
      return S3 || (R3 = "errored", _2 = e3, n2 ? L2(true, e3) : z2(() => i2.cancel(e3), true, e3)), null;
    }
    if (void 0 !== a2 && (k2 = () => {
    ...
    function F2(e3, t3) {
      return S3 = true, l2.releaseLock(), i2.releaseLock(), void 0 !== a2 && a2.removeEventListener("abort", k2), e3 ? W3(t3) : P2(void 0), null;
    }
  ...
  return function(e3) {
    ...
    function g2() {
      l2 && (i2.releaseLock(), i2 = e3.getReader(), y2(i2), l2 = false), b(i2.read(), (e4) => {
        ...
        return h2 || o2.enqueue(u2), p2 || n2.enqueue(c2), s2 = false, d2 ? S3() : f2 && v2(), null;
      }, () => (s2 = false, null));
    }
    function w2(t4, r3) {
      ...
      b(i2.read(t4), (e4) => {
        ...
        return s2 = false, d2 ? S3() : f2 && v2(), null;
      }, () => (s2 = false, null));
    }
    function S3() {
    ...
    const q2 = new ReadableStream2({ type: "bytes", start(e4) {
      o2 = e4;
    }, pull: S3, cancel: R3 }), C2 = new ReadableStream2({ type: "bytes", start(e4) {
      n2 = e4;
    }, pull: v2, cancel: T2 });
    return y2(i2), [q2, C2];
  }(e2) : function(e3, t3) {
    ...
    return _(r2.closed, (e4) => (a2.error(e4), i2.error(e4), f2 && h2 || l2(void 0), null)), [w2, S3];
  }(e2);
}
function Bt(e2) {
...
function Gt(e2, r2) {
  ...
  if (void 0 !== o2 && Fe(o2)) {
    ...
    o2._readIntoRequests = new S2(), e3.forEach((e4) => {
...
function Xt(e2) {
  ...
  if (void 0 !== t2 && (j(t2), K(t2))) {
    ...
    t2._readRequests = new S2(), e3.forEach((e4) => {
      e4._closeSteps();
    });
  }
}
  ...
  "node_modules/web-streams-polyfill/dist/ponyfill.mjs"() {
    ...
    ReadableStreamDefaultReader = class {
      constructor(e2) {
        ...
        E(this, e2), this._readRequests = new S2();
      }
      get closed() {
    ...
    ReadableByteStreamController = class {
      ...
      [C]() {
        if (this._pendingPullIntos.length > 0) {
          ...
          e2.readerType = "none", this._pendingPullIntos = new S2(), this._pendingPullIntos.push(e2);
        }
      }
    };
    ...
    ReadableStreamBYOBReader = class {
      constructor(e2) {
        ...
        E(this, e2), this._readIntoRequests = new S2();
      }
      get closed() {
...
// functions/src/prewarm.ts
var prewarm_exports = {};
__export(prewarm_exports, {
  list: () => list,
  one: () => one
});
module.exports = __toCommonJS(prewarm_exports);
...
var CATALOG = [
  // ---- France: Bordeaux ----
  { producer: "Ch\xE2teau Margaux", country: "France", wines: [
    { name: "Ch\xE2teau Margaux", type: R, region: "Margaux" },
    { name: "Pavillon Rouge", type: R, region: "Margaux" }
  ] },
  { producer: "Ch\xE2teau Lafite Rothschild", country: "France", wines: [
    { name: "Ch\xE2teau Lafite Rothschild", type: R, region: "Pauillac" },
    { name: "Carruades de Lafite", type: R, region: "Pauillac" }
  ] },
  { producer: "Ch\xE2teau Latour", country: "France", wines: [
    { name: "Ch\xE2teau Latour", type: R, region: "Pauillac" },
    { name: "Les Forts de Latour", type: R, region: "Pauillac" }
  ] },
  { producer: "Ch\xE2teau Mouton Rothschild", country: "France", wines: [
    { name: "Ch\xE2teau Mouton Rothschild", type: R, region: "Pauillac" }
  ] },
  { producer: "Ch\xE2teau Haut-Brion", country: "France", wines: [
    { name: "Ch\xE2teau Haut-Brion", type: R, region: "Pessac-L\xE9ognan" },
    { name: "Ch\xE2teau Haut-Brion Blanc", type: W, region: "Pessac-L\xE9ognan" }
  ] },
  { producer: "Ch\xE2teau P\xE9trus", country: "France", wines: [
    { name: "P\xE9trus", type: R, region: "Pomerol" }
  ] },
  { producer: "Ch\xE2teau Cheval Blanc", country: "France", wines: [
    { name: "Ch\xE2teau Cheval Blanc", type: R, region: "Saint-\xC9milion" }
  ] },
  { producer: "Ch\xE2teau d'Yquem", country: "France", wines: [
    { name: "Ch\xE2teau d'Yquem", type: D, region: "Sauternes" }
  ] },
  // ---- France: Burgundy ----
  { producer: "Domaine de la Roman\xE9e-Conti", country: "France", wines: [
    { name: "Roman\xE9e-Conti Grand Cru", type: R, region: "Vosne-Roman\xE9e" },
    { name: "La T\xE2che Grand Cru", type: R, region: "Vosne-Roman\xE9e" },
    { name: "Richebourg Grand Cru", type: R, region: "Vosne-Roman\xE9e" },
  ...
  { producer: "Domaine Leflaive", country: "France", wines: [
    ...
    { name: "B\xE2tard-Montrachet Grand Cru", type: W, region: "Puligny-Montrachet" }
  ] },
  { producer: "Domaine Coche-Dury", country: "France", wines: [
    { name: "Corton-Charlemagne Grand Cru", type: W, region: "Aloxe-Corton" },
    { name: "Meursault Perri\xE8res", type: W, region: "Meursault" }
  ] },
  // ---- France: Champagne ----
  { producer: "Dom P\xE9rignon", country: "France", wines: [
    { name: "Dom P\xE9rignon Vintage", type: S, region: "Champagne" },
    { name: "Dom P\xE9rignon P2", type: S, region: "Champagne" },
    { name: "Dom P\xE9rignon Ros\xE9", type: S, region: "Champagne" }
  ] },
  { producer: "Krug", country: "France", wines: [
    { name: "Krug Grande Cuv\xE9e", type: S, region: "Champagne" },
  ...
  { producer: "Louis Roederer", country: "France", wines: [
    ...
    { name: "Cristal Ros\xE9", type: S, region: "Champagne" }
  ] },
  ...
  { producer: "E. Guigal", country: "France", wines: [
    { name: "La Landonne", type: R, region: "C\xF4te-R\xF4tie" },
    { name: "La Mouline", type: R, region: "C\xF4te-R\xF4tie" },
    { name: "La Turque", type: R, region: "C\xF4te-R\xF4tie" }
  ] },
  { producer: "Ch\xE2teau de Beaucastel", country: "France", wines: [
    { name: "Ch\xE2teauneuf-du-Pape", type: R, region: "Ch\xE2teauneuf-du-Pape" },
    { name: "Hommage \xE0 Jacques Perrin", type: R, region: "Ch\xE2teauneuf-du-Pape" }
  ] },
  // ---- France: Alsace ----
  { producer: "Trimbach", country: "France", wines: [
    { name: "Clos Sainte Hune Riesling", type: W, region: "Alsace" },
    { name: "Riesling Fr\xE9d\xE9ric Emile", type: W, region: "Alsace" }
  ] },
  // ---- Italy ----
  ...
  { producer: "Vega Sicilia", country: "Spain", wines: [
    { name: "\xDAnico", type: R, region: "Ribera del Duero" },
    { name: "Valbuena 5\xB0", type: R, region: "Ribera del Duero" }
  ] },
  ...
  // ---- Rosé ----
  { producer: "Ch\xE2teau d'Esclans", country: "France", wines: [
    { name: "Whispering Angel", type: Ro, region: "Provence" },
    { name: "Garrus", type: Ro, region: "Provence" }
  ] }
];
var topWines = CATALOG.flatMap(
  (row) => row.wines.map((w2) => ({
...
var Anthropic = class extends APIClient {
   ...
   */
  constructor({ baseURL = readEnv("ANTHROPIC_BASE_URL"), apiKey: apiKey2 = readEnv("ANTHROPIC_API_KEY") ?? null, authToken = readEnv("ANTHROPIC_AUTH_TOKEN") ?? null, ...opts } = {}) {
    const options = {
      apiKey: apiKey2,
      authToken,
      ...opts,
...
function cacheKeyFor(nom, brand) {
...
async function apiKey() {
  ...
  const out = await sm.send(new import_client_secrets_manager.GetSecretValueCommand({ SecretId: id }));
...
async function logUsage(model, usage) {
  ...
  const p2 = `${feature}#${family(model)}`;
  try {
    await doc.send(new import_lib_dynamodb2.UpdateCommand({
      TableName: TABLE,
      Key: { PK: "AICOST", SK: day },
      UpdateExpression: "SET #t = :t ADD #in :in, #out :out, #cr :cr, #cw :cw, #n :one",
      ExpressionAttributeNames: { "#t": "type", "#in": `${p2}_in`, "#out": `${p2}_out`, "#cr": `${p2}_cr`, "#cw": `${p2}_cw`, "#n": `${p2}_n` },
...
async function getClient() {
  ...
  client = new sdk_default({ apiKey: await apiKey() });
  return client;
}
async function callOnce(tier, input) {
  ...
  void logUsage(MODELS[tier], msg.usage);
  return msg.content.filter((b2) => b2.type === "text").map((b2) => b2.text).join("\n");
}
async function callTiered(input, accept, ladder = ["haiku", "sonnet", "opus"]) {
  let last = "";
...
// functions/src/enrich.ts
var SYSTEM = `You are a wine expert building structured catalog entries.
...
JSON shape:
{
  "brand": string, "name": string, "nom": string, "expression": "Blanco"|"High Proof Blanco"|"Reposado"|"A\xF1ejo"|"Extra A\xF1ejo"|"Cristalino",
...
var ACCENTS = {
  ...
  Reposado: "#C28A3D",
  "A\xF1ejo": "#A66A33",
  "Extra A\xF1ejo": "#8C4A2F",
  Cristalino: "#9AA7B2"
};
var handler = async (event) => {
  const userText = buildUserText(event);
  const accept = (text2) => {
    const j2 = extractJson(text2);
    return Boolean(j2 && j2.brand && j2.nom && j2.expression && (j2.confidence ?? 0) >= 0.7);
  };
  const ladder = event.imageBase64 ? ["sonnet", "opus"] : ["haiku", "sonnet", "opus"];
  ...
  const bottle = {
    ...
    verified: false,
    // generated — awaits admin review
    imageKeys: event.imageKey ? [event.imageKey] : void 0,
    createdAt: now,
    updatedAt: now
  };
  await putItem({
...
function buildUserText(e2) {
  if (e2.hint) {
    const { brand, expression, nom } = e2.hint;
    return `Build the catalog entry for: ${brand}${expression ? " " + expression : ""}${nom ? ` (NOM ${nom})` : ""}. Return only JSON.`;
  }
...
async function cachedBottle(nom, brand) {
  const ptr = await getItem(keys.cache(cacheKeyFor(nom, brand)));
  if (!ptr?.bottleId) return null;
  const b2 = await getItem(keys.bottle(ptr.bottleId));
  return b2 ?? null;
}
function slug(s2) {
...
var one = async (entry) => {
  try {
    ...
    const bottle = await handler({
      hint: { brand: entry.brand, expression: entry.expression, nom: entry.nom }
    });
    return {
      brand: entry.brand,
      expression: entry.expression,
